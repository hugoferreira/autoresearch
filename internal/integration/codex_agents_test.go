...
var _ = ginkgo.Describe("TestEmbeddedCodexAgents_RewrittenForCodex", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestEmbeddedCodexAgents_NotebookPropagation", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestCodexDelegationHandoffContract", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestInstallCodexAgents", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestInstallCodexAgents_RemovesLegacyMarkdown", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestInstallCodexAgents_PreservesSiblingFiles", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
