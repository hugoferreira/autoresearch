...
var _ = ginkgo.Describe("TestEnsureClaudeSettings_Created", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestEnsureClaudeSettings_AddsToExistingAllow", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestEnsureClaudeSettings_Idempotent", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestEnsureClaudeSettings_NoPermissionsKey", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestEnsureClaudeSettings_InvalidJSON", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestWorktreeAllowEntries_UsesDoubleSlashForAbsolute", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestPreviewClaudeSettings", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
