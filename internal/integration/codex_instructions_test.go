...
var _ = ginkgo.Describe("TestEnsureCodexInstructions_Created", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestEnsureCodexInstructions_AppendsManagedBlock", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestEnsureCodexInstructions_Idempotent", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestPreviewCodexInstructions", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
