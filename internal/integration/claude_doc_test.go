...
var _ = ginkgo.Describe("TestSharedDocs_CommandSpineUsesParentReviewHandoff", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestSharedDocs_MainCheckoutIsolationContract", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestSharedDocs_LessonScopeGuidance", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
