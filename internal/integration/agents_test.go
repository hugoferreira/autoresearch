...
var _ = ginkgo.Describe("TestEmbeddedAgents_AllPresent", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestEmbeddedAgents_FrontmatterValid", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestInstallAgents", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestInstallAgents_Idempotent", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
