...
var _ = testkit.Spec("TestOpenMigratesExperimentGoalIDProvenance", func(t testkit.T) {
	s, dir := mustCreate(t)
...
var _ = testkit.Spec("TestOpenV2ToV3FailsOnMissingLegacyBaselineGoal", func(t testkit.T) {
	s, dir := mustCreate(t)
...
var _ = testkit.Spec("TestOpenV2ToV3IgnoresMalformedLegacyBaselinePayloadWhenGoalIDPresent", func(t testkit.T) {
	s, dir := mustCreate(t)
