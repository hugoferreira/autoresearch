...
var _ = ginkgo.Describe("TestCache_ReadReturnsSamePointerOnHit", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestCache_InvalidatesAfterWrite", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestCache_InvalidatesOnMtimeBump", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestCache_DropsOnDeletion", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestCache_StateReturnsIndependentCopy", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestEventsSince_IncrementalRead", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestInvalidateFromEvents_DropsByPrefix", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
