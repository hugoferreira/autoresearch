...
func newTestStore(t testkit.T) *Store {
	t.Helper()
	dir := t.TempDir()
...
var _ = testkit.Spec("TestCache_ReadReturnsSamePointerOnHit", func(t testkit.T) {
	s := newTestStore(t)
	h := &entity.Hypothesis{
		ID:     "H-0001",
		Claim:  "test",
...
var _ = testkit.Spec("TestCache_InvalidatesAfterWrite", func(t testkit.T) {
	s := newTestStore(t)
	h := &entity.Hypothesis{
...
var _ = testkit.Spec("TestCache_InvalidatesOnMtimeBump", func(t testkit.T) {
	s := newTestStore(t)
	h := &entity.Hypothesis{
		ID: "H-0001", Claim: "v1", Status: entity.StatusOpen,
		Predicts: entity.Predicts{Instrument: "x", Target: "y", Direction: "decrease", MinEffect: 0.1},
...
var _ = testkit.Spec("TestCache_DropsOnDeletion", func(t testkit.T) {
	s := newTestStore(t)
	h := &entity.Hypothesis{
		ID: "H-0001", Claim: "v1", Status: entity.StatusOpen,
		Predicts: entity.Predicts{Instrument: "x", Target: "y", Direction: "decrease", MinEffect: 0.1},
...
var _ = testkit.Spec("TestCache_StateReturnsIndependentCopy", func(t testkit.T) {
	s := newTestStore(t)
	st1, err := s.State()
	if err != nil {
		t.Fatal(err)
...
var _ = testkit.Spec("TestEventsSince_IncrementalRead", func(t testkit.T) {
	s := newTestStore(t)
...
var _ = testkit.Spec("TestInvalidateFromEvents_DropsByPrefix", func(t testkit.T) {
	s := newTestStore(t)
	h := &entity.Hypothesis{
		ID: "H-0001", Claim: "v1", Status: entity.StatusOpen,
		Predicts: entity.Predicts{Instrument: "x", Target: "y", Direction: "decrease", MinEffect: 0.1},
