...
func mustCreate(t *testing.T) (*store.Store, string) {
	t.Helper()
	dir := t.TempDir()
...
func TestCreateRejectsDouble(t *testing.T) {
	_, dir := mustCreate(t)
...
func TestOpenWalksUpToFindStore(t *testing.T) {
	root, _ := mustCreate(t)
...
func TestOpenWalkStopsAtFilesystemRoot(t *testing.T) {
