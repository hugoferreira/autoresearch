...
var _ = testkit.Spec("TestLessonCRUD", func(t testkit.T) {
	s, _ := mustCreate(t)
...
var _ = testkit.Spec("TestLessonListByScopeAndSubject", func(t testkit.T) {
	s, _ := mustCreate(t)
	now := time.Now().UTC()
...
var _ = testkit.Spec("TestListLessonsOnMissingDir", func(t testkit.T) {
...
var _ = testkit.Spec("TestListLessonsOrdersByNumericIDAcrossFiveDigits", func(t testkit.T) {
	s, _ := mustCreate(t)
	now := time.Now().UTC()
