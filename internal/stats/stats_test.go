...
func TestSummarizeBracketsMean(t *testing.T) {
...
func TestSummarizeNoiseDoesNotCollapseCI(t *testing.T) {
...
func TestCompareSamplesClearDecrease(t *testing.T) {
...
func TestCompareSamplesNoDifference(t *testing.T) {
