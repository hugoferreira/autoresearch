...
var _ = ginkgo.Describe("TestMeanStdDev", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestPercentile", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestSummarizeBracketsMean", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestSummarizeNoiseDoesNotCollapseCI", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestCompareSamplesClearDecrease", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestCompareSamplesNoDifference", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestMannWhitneyUKnown", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestDeterministicSeed", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
