...
var _ = testkit.Spec("TestPassFail", func(t testkit.T) {
	dir := t.TempDir()
...
var _ = testkit.Spec("TestTiming", func(t testkit.T) {
	dir := t.TempDir()
	r, err := instrument.Run(context.Background(), instrument.Config{
		ProjectDir:  dir,
		WorktreeDir: dir,
...
var _ = testkit.Spec("TestSize_GNUFormat", func(t testkit.T) {
	dir := t.TempDir()
...
var _ = testkit.Spec("TestSize_MachOFormat", func(t testkit.T) {
	dir := t.TempDir()
	r, err := instrument.Run(context.Background(), instrument.Config{
		ProjectDir:  dir,
		WorktreeDir: dir,
...
var _ = testkit.Spec("TestUnknownParser", func(t testkit.T) {
...
var _ = testkit.Spec("TestScalar_KeywordFormat", func(t testkit.T) {
	dir := t.TempDir()
	r, err := instrument.Run(context.Background(), instrument.Config{
		ProjectDir:  dir,
		WorktreeDir: dir,
...
var _ = testkit.Spec("TestScalar_JsonFormat", func(t testkit.T) {
	dir := t.TempDir()
	r, err := instrument.Run(context.Background(), instrument.Config{
		WorktreeDir: dir,
		Samples:     2,
...
var _ = testkit.Spec("TestScalar_CaseInsensitive", func(t testkit.T) {
	dir := t.TempDir()
	r, err := instrument.Run(context.Background(), instrument.Config{
		WorktreeDir: dir,
		Samples:     2,
...
var _ = testkit.Spec("TestScalar_NoMatchRejected", func(t testkit.T) {
	dir := t.TempDir()
	_, err := instrument.Run(context.Background(), instrument.Config{
		WorktreeDir: dir,
		Samples:     1,
...
var _ = testkit.Spec("TestScalar_MissingPatternRejected", func(t testkit.T) {
	dir := t.TempDir()
	_, err := instrument.Run(context.Background(), instrument.Config{
		WorktreeDir: dir,
		Samples:     1,
...
var _ = testkit.Spec("TestScalar_MultipleGroupsRejected", func(t testkit.T) {
	dir := t.TempDir()
	_, err := instrument.Run(context.Background(), instrument.Config{
		WorktreeDir: dir,
		Samples:     1,
...
var _ = testkit.Spec("TestScalar_NonIntegerCaptureRejected", func(t testkit.T) {
	dir := t.TempDir()
	_, err := instrument.Run(context.Background(), instrument.Config{
		WorktreeDir: dir,
		Samples:     1,
...
var _ = testkit.Spec("TestScalar_UnitHonored", func(t testkit.T) {
	dir := t.TempDir()
	r, err := instrument.Run(context.Background(), instrument.Config{
		WorktreeDir: dir,
		Samples:     1,
...
var _ = testkit.Spec("TestEvidence_ArtifactUsesShellContext", func(t testkit.T) {
	dir := t.TempDir()
	r, err := instrument.Run(context.Background(), instrument.Config{
		ProjectDir:  dir,
		WorktreeDir: dir,
...
var _ = testkit.Spec("TestEvidence_FailureNonFatal", func(t testkit.T) {
	dir := t.TempDir()
...
var _ = testkit.Spec("TestEvidence_SpawnFailureRecordsErrorWithoutExitCode", func(t testkit.T) {
	dir := t.TempDir()
