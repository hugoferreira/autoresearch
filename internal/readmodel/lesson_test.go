...
var _ = ginkgo.Describe("TestListLessonsForRead_FiltersAndSince", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestListLessonsForRead_SinceUsesOrdinalNotLexicalOrder", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestBuildLessonSummaryViews_TruncatesClaimAndPreservesTags", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestParseLessonFieldsAndProject", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestParseLessonFields_RejectsUnknownField", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
