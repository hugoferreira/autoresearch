...
func TestListLessonsForRead_FiltersAndSince(t *testing.T) {
...
func TestBuildLessonSummaryViews_TruncatesClaimAndPreservesTags(t *testing.T) {
...
func TestParseLessonFieldsAndProject(t *testing.T) {
...
func TestParseLessonFields_RejectsUnknownField(t *testing.T) {
