...
var _ = testkit.Spec("TestAssessGoalCompletion_CountsReviewedSupportedCandidatesAfterAcceptance", func(t testkit.T) {
	goal := &entity.Goal{
...
var _ = testkit.Spec("TestBuildFrontierSnapshot_ComposesRowsAssessmentAndStall", func(t testkit.T) {
	goal := &entity.Goal{
		Objective: entity.Objective{Instrument: "host_timing", Direction: "decrease"},
		Completion: &entity.Completion{
			Threshold:   0.1,
...
var _ = testkit.Spec("TestComputeFrontierFromObservations_UsesConclusionCandidateScope", func(t testkit.T) {
	goal := &entity.Goal{
		Objective: entity.Objective{Instrument: "host_timing", Direction: "decrease"},
	}
	concls := []*entity.Conclusion{
...
var _ = testkit.Spec("TestAssessGoalCompletion_UsesReviewedConclusionScope", func(t testkit.T) {
	goal := &entity.Goal{
		Objective: entity.Objective{Instrument: "host_timing", Direction: "decrease"},
		Completion: &entity.Completion{
			Threshold:   0.15,
