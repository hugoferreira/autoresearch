...
var _ = ginkgo.Describe("TestAssessGoalCompletion_CountsReviewedSupportedCandidatesAfterAcceptance", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestBuildFrontierSnapshot_ComposesRowsAssessmentAndStall", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestComputeFrontierFromObservations_UsesConclusionCandidateScope", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestAssessGoalCompletion_UsesReviewedConclusionScope", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
