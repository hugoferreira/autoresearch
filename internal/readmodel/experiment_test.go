...
var _ = testkit.Spec("TestClassifyHypothesisStatusForExperimentRead", func(t testkit.T) {
	cases := []struct {
		name       string
		status     string
		class      string
...
var _ = testkit.Spec("TestClassifyExperimentsForReadFromHypotheses", func(t testkit.T) {
...
var _ = testkit.Spec("TestFindStaleExperimentsForRead_ExcludesNonActionableWork", func(t testkit.T) {
...
var _ = testkit.Spec("TestFindStaleExperimentsForRead_CountsObservationRecordAsActivity", func(t testkit.T) {
	now := time.Date(2026, 4, 18, 20, 0, 0, 0, time.UTC)
	exps := []*entity.Experiment{
		{ID: "E-0001", Hypothesis: "H-0001", Status: entity.ExpMeasured},
	}
...
var _ = testkit.Spec("TestBuildInFlightExperiments_FiltersAndSorts", func(t testkit.T) {
	now := time.Date(2026, 4, 18, 20, 0, 0, 0, time.UTC)
	exps := []*entity.Experiment{
		{
			ID: "E-0001", Hypothesis: "H-0001", Status: entity.ExpMeasured,
...
var _ = testkit.Spec("TestBuildExperimentActivity_UsesSharedThresholdAndNow", func(t testkit.T) {
	now := time.Date(2026, 4, 18, 20, 0, 0, 0, time.UTC)
	exps := []*entity.Experiment{
