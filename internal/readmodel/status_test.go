...
var _ = testkit.Spec("TestBuildBudgetSnapshot", func(t testkit.T) {
...
var _ = testkit.Spec("TestBuildCounts", func(t testkit.T) {
...
var _ = testkit.Spec("TestBuildCountsWithLessons", func(t testkit.T) {
...
var _ = testkit.Spec("TestFindUnobservedGoalInstruments", func(t testkit.T) {
	flashMax := 100.0
	goal := &entity.Goal{
