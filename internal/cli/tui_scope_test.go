...
var _ = testkit.Spec("TestTUI_GoalListViewShowsSessionScope", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_GoalDetailViewShowsSessionScope", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_GoalListCanRetargetScope", func(t testkit.T) {
	goals := []*entity.Goal{
		{ID: "G-0001", Status: entity.GoalStatusConcluded, Objective: entity.Objective{Instrument: "host_timing", Direction: "decrease"}},
		{ID: "G-0002", Status: entity.GoalStatusActive, Objective: entity.Objective{Instrument: "qemu_cycles", Direction: "decrease"}},
	}
...
var _ = testkit.Spec("TestTUI_GoalDetailCanBroadenScope", func(t testkit.T) {
