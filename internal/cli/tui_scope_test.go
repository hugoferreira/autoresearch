...
var _ = ginkgo.Describe("TestTUI_GoalListViewShowsSessionScope", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestTUI_GoalDetailViewShowsSessionScope", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestTUI_GoalListCanRetargetScope", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestTUI_GoalDetailCanBroadenScope", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
