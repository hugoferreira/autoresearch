...
var _ = testkit.Spec("TestBuildGoalFromFlags_DefaultsThresholdPolicy", func(t testkit.T) {
...
var _ = testkit.Spec("TestBuildGoalFromFlags_RejectsOnSuccessWithoutThreshold", func(t testkit.T) {
...
var _ = testkit.Spec("TestBuildGoalFromFlags_RejectsNegativeThreshold", func(t testkit.T) {
	_, err := buildGoalFromFlags(
		"host_timing",
		"dsp_fir",
		"decrease",
...
var _ = testkit.Spec("TestBuildGoalFromFlags_RescuersRequireNeutralBand", func(t testkit.T) {
	_, err := buildGoalFromFlags(
...
var _ = testkit.Spec("TestBuildGoalFromFlags_NeutralBandWithoutRescuerRejected", func(t testkit.T) {
	_, err := buildGoalFromFlags(
		"host_timing", "dsp_fir", "decrease",
		0, "",
		[]string{"size_flash=131072"}, nil, nil,
...
var _ = testkit.Spec("TestBuildGoalFromFlags_RescuerAccepted", func(t testkit.T) {
	g, err := buildGoalFromFlags(
		"host_timing", "dsp_fir", "decrease",
		0, "",
		[]string{"size_flash=131072"}, nil, nil,
...
var _ = testkit.Spec("TestFrontierRowBetter_RescuerTiebreak", func(t testkit.T) {
	goal := &entity.Goal{
...
var _ = testkit.Spec("TestAssessGoalCompletion", func(t testkit.T) {
...
var _ = testkit.Spec("TestComputeFrontierFromObservations_CarriesExperimentClassification", func(t testkit.T) {
	goal := &entity.Goal{
		Objective: entity.Objective{Instrument: "host_timing", Direction: "decrease"},
	}
	concls := []*entity.Conclusion{
...
var _ = testkit.Spec("TestComputeFrontierFromObservations_StalledForCountsLaterConclusionsAfterAcceptedWin", func(t testkit.T) {
	goal := &entity.Goal{
		Objective: entity.Objective{Instrument: "host_timing", Direction: "decrease"},
	}
