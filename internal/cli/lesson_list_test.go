...
var _ = testkit.Spec("TestLessonListJSONSummarySupportsSince", func(t testkit.T) {
	saveGlobals(t)
...
var _ = testkit.Spec("TestLessonListJSONFieldsProjectsRequestedKeys", func(t testkit.T) {
	saveGlobals(t)
	dir, s := setupGoalStore(t)
	now := time.Date(2026, 4, 19, 12, 0, 0, 0, time.UTC)
...
var _ = testkit.Spec("TestLessonListRejectsSummaryAndFieldsTogether", func(t testkit.T) {
	saveGlobals(t)
