...
var _ = ginkgo.Describe("TestLessonListJSONSummarySupportsSince", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestLessonListJSONFieldsProjectsRequestedKeys", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestLessonListRejectsSummaryAndFieldsTogether", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
