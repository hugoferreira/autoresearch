...
var _ = ginkgo.Describe("TestConclusionShowJSON_JoinsObservationArtifacts", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestConclusionShowJSON_OmitsObservationArtifactsWhenNoObservations", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
