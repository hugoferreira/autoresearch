...
var _ = ginkgo.Describe("TestEventPayload_HypothesisKillRecordsFromTo", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestEventPayload_HypothesisReopenRecordsFromTo", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestEventPayload_InstrumentRegisterEmitsFieldMap", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestEventPayload_ObservationRecordIncludesEvidenceFailures", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
