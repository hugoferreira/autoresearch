...
func findLastEvent(t testkit.T, s *store.Store, kind string) *store.Event {
	t.Helper()
...
func decodePayload(t testkit.T, e *store.Event) map[string]any {
	t.Helper()
...
func setupGoalStore(t testkit.T) (string, *store.Store) {
	t.Helper()
	dir := t.TempDir()
...
var _ = testkit.Spec("TestEventPayload_HypothesisKillRecordsFromTo", func(t testkit.T) {
	saveGlobals(t)
...
var _ = testkit.Spec("TestEventPayload_HypothesisReopenRecordsFromTo", func(t testkit.T) {
	saveGlobals(t)
	dir, s := setupGoalStore(t)
...
var _ = testkit.Spec("TestEventPayload_InstrumentRegisterEmitsFieldMap", func(t testkit.T) {
	saveGlobals(t)
	dir := t.TempDir()
...
var _ = testkit.Spec("TestEventPayload_ObservationRecordIncludesEvidenceFailures", func(t testkit.T) {
	saveGlobals(t)
