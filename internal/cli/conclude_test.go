...
var _ = ginkgo.Describe("TestConclude_JSONSurfacesResolutionAndEventAudit", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestConclude_TextOutputSurfacesFallback", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestConclude_ExplicitBaselineRemainsStrict", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestConclude_RefusesMixedCandidateProvenance", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestConclude_RefusesMixedCandidateScopeAcrossAttempts", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestConclude_UsesScopedRescuerComparison", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
