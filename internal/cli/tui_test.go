...
func applyTUICommand(t testkit.T, m tuiModel, cmd tea.Cmd) tuiModel {
	t.Helper()
	if cmd == nil {
		return m
	}
...
var _ = testkit.Spec("TestTUI_DashboardRenders", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_DashboardNarrowFallback", func(t testkit.T) {
	v := newDashboardView(goalScope{All: true})
	nv, _ := v.update(dashLoadedMsg{snap: tuiRichSnapshot()}, nil)
...
var _ = testkit.Spec("TestTUI_DashboardQuietTickAdvancesElapsedFieldsWithoutResettingState", func(t testkit.T) {
	v := newDashboardView(goalScope{All: true})
...
var _ = testkit.Spec("TestTUI_DashboardLessonPanelUsesAccuracyArrows", func(t testkit.T) {
	snap := tuiRichSnapshot()
...
var _ = testkit.Spec("TestTUI_HypothesisList", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_HypothesisDetail", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_HypothesisDetailOpensLinkedEntities", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_ExperimentList", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_ExperimentListShowsDeadClassification", func(t testkit.T) {
	v := newExperimentListView(goalScope{All: true})
	es := []*experimentReadView{
...
var _ = testkit.Spec("TestTUI_ExperimentDetail", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_ExperimentDetailShowsDeadClassification", func(t testkit.T) {
	v := newExperimentDetailView("E-0007")
	e := &entity.Experiment{
		ID: "E-0007", Hypothesis: "H-0002", Status: entity.ExpMeasured,
		Instruments: []string{"qemu_cycles"}, Author: "agent:impl",
...
var _ = testkit.Spec("TestTUI_ObservationDetail", func(t testkit.T) {
	pass := true
...
var _ = testkit.Spec("TestTUI_ObservationDetailShowsEvidenceSpawnFailure", func(t testkit.T) {
	o := testObservationDetailEntity()
	o.EvidenceFailures = []entity.EvidenceFailure{{
		Name:  testEvidenceName,
...
var _ = testkit.Spec("TestTUI_ConclusionList", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_ConclusionDetail", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_EventListAndDetail", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_LessonDetailRendersMarkdown", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_LessonListUsesAccuracyArrows", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_PrettyJSON", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_TreeView", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_FrontierView", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_FrontierViewShowsHypothesisStatusMarker", func(t testkit.T) {
	v := newFrontierView(goalScope{GoalID: "G-0001"})
	g := &entity.Goal{Objective: entity.Objective{Instrument: "qemu_cycles", Direction: "decrease"}}
	rows := []frontierRow{{
...
var _ = testkit.Spec("TestTUI_DashboardFrontierShowsHypothesisStatusMarker", func(t testkit.T) {
	v := newDashboardView(goalScope{All: true})
	snap := tuiRichSnapshot()
...
var _ = testkit.Spec("TestTUI_GoalDetailView", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_GoalListView", func(t testkit.T) {
	v := newGoalListView()
	goals := []*entity.Goal{
...
var _ = testkit.Spec("TestTUI_StatusView", func(t testkit.T) {
	snap := tuiRichSnapshot()
	snap.ScopeAll = true
...
var _ = testkit.Spec("TestTUI_StatusViewShowsStalledMeterForGoalScope", func(t testkit.T) {
	snap := tuiRichSnapshot()
...
var _ = testkit.Spec("TestTUI_StatusQuietTickAdvancesElapsedBudget", func(t testkit.T) {
	snap := tuiRichSnapshot()
	v := newStatusView(goalScope{All: true})
	nv, _ := v.update(dashLoadedMsg{snap: snap}, nil)
...
var _ = testkit.Spec("TestTUI_DashboardAndStatusShowDirtyMainCheckout", func(t testkit.T) {
	snap := tuiRichSnapshot()
...
var _ = testkit.Spec("TestTUI_ModelHeaderAndHints", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_ArtifactList", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_ArtifactViewHeader", func(t testkit.T) {
	row := artifactRow{
...
var _ = testkit.Spec("TestTUI_ArtifactDiffView", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_InstrumentList", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_ReportView", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_ExperimentDetailWithStats", func(t testkit.T) {
	v := newExperimentDetailView("E-0007")
	e := &entity.Experiment{
		ID: "E-0007", Hypothesis: "H-0002", Status: entity.ExpMeasured,
		Instruments: []string{"qemu_cycles"}, Author: "agent:impl",
...
var _ = testkit.Spec("TestTUI_JumpToCanonicalizes", func(t testkit.T) {
	m := newTuiModel(nil, goalScope{All: true}, 2*time.Second)
	// Start: [dashboard]
...
var _ = testkit.Spec("TestTUI_JumpToPreservesDashboardState", func(t testkit.T) {
	m := newTuiModel(nil, goalScope{All: true}, 2*time.Second)
	dash := newDashboardView(goalScope{All: true})
...
var _ = testkit.Spec("TestTUI_PopBackToDashboardReloadsHiddenDashboard", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_EventListKeysDoNotConflictWithRootShortcuts", func(t testkit.T) {
	v := newEventListView(goalScope{All: true})
	es := []store.Event{
...
var _ = testkit.Spec("TestTUI_GoalShortcutUsesO", func(t testkit.T) {
	m := newTuiModel(nil, goalScope{All: true}, 2*time.Second)
...
var _ = testkit.Spec("TestTUI_DashboardForwardsLoadMsgToOverlay", func(t testkit.T) {
...
var _ = testkit.Spec("TestTUI_DashboardTreePanelTitleUsesBorder", func(t testkit.T) {
	d := newDashboardView(goalScope{All: true})
...
var _ = testkit.Spec("TestTUI_DashboardRecentEventsPaging", func(t testkit.T) {
	s := newStoreWithBuiltins(t)
...
var _ = testkit.Spec("TestTUI_DashboardRightColumnGivesEventsRemainder", func(t testkit.T) {
	d := newDashboardView(goalScope{All: true})
	d.snap = tuiRichSnapshot()
...
var _ = testkit.Spec("TestTUI_DashboardVisualDump", func(t testkit.T) {
	if testing.Short() {
		t.Skip()
	}
	snap := tuiRichSnapshot()
...
var _ = testkit.Spec("TestTUI_ReportViewRendersMarkdown", func(t testkit.T) {
	v := newReportView("H-0007")
...
var _ = testkit.Spec("TestTUI_ReportViewCachesByWidth", func(t testkit.T) {
	v := newReportView("H-0007")
...
var _ = testkit.Spec("TestTUI_ReportViewVisualDump", func(t testkit.T) {
	if testing.Short() {
		t.Skip()
	}
	v := newReportView("H-0007")
...
var _ = testkit.Spec("TestTUI_EventDetailVisualDump", func(t testkit.T) {
	if testing.Short() {
		t.Skip()
	}
	ev := store.Event{
...
var _ = testkit.Spec("TestTUI_ExperimentDetailVisualDump", func(t testkit.T) {
	if testing.Short() {
		t.Skip()
	}
	v := newExperimentDetailView("E-0007")
