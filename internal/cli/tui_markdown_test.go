...
var _ = ginkgo.Describe("TestEntityIDPattern", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestHighlightEntityIDs_WrapsIDs", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestHighlightEntityIDs_StartOfStringAndLine", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestHighlightEntityIDs_AfterGlamourANSI", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestHighlightEntityIDs_PreservesNonMatches", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestHighlightEntityIDs_SkipsInsideHyphenatedWord", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
