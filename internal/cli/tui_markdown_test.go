...
func TestHighlightEntityIDs_WrapsIDs(t *testing.T) {
	forceColorProfile(t)
...
func TestHighlightEntityIDs_StartOfStringAndLine(t *testing.T) {
	forceColorProfile(t)
	cases := []string{
...
func TestHighlightEntityIDs_AfterGlamourANSI(t *testing.T) {
	forceColorProfile(t)
...
func TestHighlightEntityIDs_PreservesNonMatches(t *testing.T) {
	forceColorProfile(t)
...
func TestHighlightEntityIDs_SkipsInsideHyphenatedWord(t *testing.T) {
	forceColorProfile(t)
