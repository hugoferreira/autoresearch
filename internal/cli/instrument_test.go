...
var _ = testkit.Spec("TestInstrumentRegister_CmdPreservesCommas", func(t testkit.T) {
	saveGlobals(t)
...
var _ = testkit.Spec("TestInstrumentRegister_CmdRepeatableArgv", func(t testkit.T) {
	saveGlobals(t)
	dir, s := setupGoalStore(t)
...
var _ = testkit.Spec("TestInstrumentRegister_EvidenceStoredInOrder", func(t testkit.T) {
	saveGlobals(t)
	dir, s := setupGoalStore(t)
...
var _ = testkit.Spec("TestInstrumentRegister_EvidenceValidation", func(t testkit.T) {
	saveGlobals(t)
