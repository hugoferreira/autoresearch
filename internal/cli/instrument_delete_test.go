...
var _ = testkit.Spec("TestInstrumentDelete_HappyPath", func(t testkit.T) {
	saveGlobals(t)
...
var _ = testkit.Spec("TestInstrumentDelete_RefusesUnknown", func(t testkit.T) {
	saveGlobals(t)
...
var _ = testkit.Spec("TestInstrumentDelete_RefusesGoalObjective", func(t testkit.T) {
	saveGlobals(t)
	dir, _ := setupGoalStore(t)
...
var _ = testkit.Spec("TestInstrumentDelete_ForceDoesNotOverrideObjective", func(t testkit.T) {
	saveGlobals(t)
	dir, _ := setupGoalStore(t)
...
var _ = testkit.Spec("TestInstrumentDelete_RefusesReferencedByHypothesis", func(t testkit.T) {
	saveGlobals(t)
	dir, s := setupGoalStore(t)
...
var _ = testkit.Spec("TestInstrumentDelete_ForceOrphans", func(t testkit.T) {
	saveGlobals(t)
	dir, s := setupGoalStore(t)
