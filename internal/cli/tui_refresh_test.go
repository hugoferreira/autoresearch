...
var _ = ginkgo.Describe("TestTUI_LessonDetail_PreservesScrollAcrossReloads", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestTUI_Artifact_ScrollResetOnlyOnUserModeChange", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestTUI_StoreChangedMsg_EmptyBatchIsNoopForNonTickViews", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestTUI_StoreChangedMsg_EmptyBatchDispatchesQuietTickToOptInView", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestTUI_StoreChangedMsg_NonEmptyBatchDispatches", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
