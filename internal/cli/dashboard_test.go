...
var _ = testkit.Spec("TestCaptureDashboard_InFlightExcludesReferencedBaselines", func(t testkit.T) {
	dir := t.TempDir()
...
var _ = testkit.Spec("TestCaptureDashboard_InFlightExcludesDeadExperiments", func(t testkit.T) {
	dir := t.TempDir()
	s, err := store.Create(dir, store.Config{
		Build: store.CommandSpec{Command: "true"},
		Test:  store.CommandSpec{Command: "true"},
...
var _ = testkit.Spec("TestCaptureDashboard_StaleExperimentsExcludeNonActionableWork", func(t testkit.T) {
...
var _ = testkit.Spec("TestRenderDashboard_Empty", func(t testkit.T) {
	snap := baseSnapshot()
...
var _ = testkit.Spec("TestRenderDashboard_FullState", func(t testkit.T) {
	snap := baseSnapshot()
	flash := 65536.0
...
var _ = testkit.Spec("TestRenderDashboard_Paused", func(t testkit.T) {
	snap := baseSnapshot()
	snap.Paused = true
...
var _ = testkit.Spec("TestRenderDashboard_MainCheckoutDirty", func(t testkit.T) {
	snap := baseSnapshot()
...
var _ = testkit.Spec("TestRenderDashboard_StatusGlyphs", func(t testkit.T) {
	snap := baseSnapshot()
	snap.Tree = []*treeNode{
...
var _ = testkit.Spec("TestRenderDashboard_FrontierUsesHypothesisStatusMarker", func(t testkit.T) {
	snap := baseSnapshot()
	snap.Goal = &entity.Goal{
...
var _ = testkit.Spec("TestRenderDashboard_Colored", func(t testkit.T) {
	snap := baseSnapshot()
	flash := 65536.0
	snap.Goal = &entity.Goal{
		Objective: entity.Objective{
...
var _ = testkit.Spec("TestRenderDashboard_NoColorWhenNil", func(t testkit.T) {
...
func newStoreWithBuiltins(t testkit.T) *store.Store {
	t.Helper()
	dir := t.TempDir()
	s, err := store.Create(dir, store.Config{
		Build: store.CommandSpec{Command: "true"},
...
var _ = testkit.Spec("TestCaptureDashboard_EmptyStore", func(t testkit.T) {
	s := newStoreWithBuiltins(t)
	snap, err := captureDashboard(s)
	if err != nil {
		t.Fatal(err)
...
var _ = testkit.Spec("TestCaptureDashboard_PauseStateReflected", func(t testkit.T) {
	s := newStoreWithBuiltins(t)
	now := time.Now().UTC()
...
var _ = testkit.Spec("TestReadDashboardRecentEvents_PagedNewestFirst", func(t testkit.T) {
	s := newStoreWithBuiltins(t)
...
var _ = testkit.Spec("TestFormatElapsed", func(t testkit.T) {
	cases := []struct {
		d    time.Duration
		want string
	}{
