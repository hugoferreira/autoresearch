...
var _ = testkit.Spec("TestGoalBodyJSON", func(t testkit.T) {
	g := &entity.Goal{
...
var _ = testkit.Spec("TestHypothesisBodyJSON", func(t testkit.T) {
	h := &entity.Hypothesis{
...
var _ = testkit.Spec("TestExperimentBodyJSON", func(t testkit.T) {
	e := &entity.Experiment{
...
var _ = testkit.Spec("TestConclusionBodyJSON", func(t testkit.T) {
	c := &entity.Conclusion{
...
var _ = testkit.Spec("TestEmptyBodyOmitted", func(t testkit.T) {
	cases := []any{
