...
var _ = testkit.Spec("TestFrontmatterRoundTrip", func(t testkit.T) {
	type doc struct {
...
var _ = testkit.Spec("TestNoFrontmatter", func(t testkit.T) {
...
var _ = testkit.Spec("TestExtractSection", func(t testkit.T) {
	body := "# Steering\n\nFocus on dsp_fir.\n\n# Notes\n\nsomething else\n"
...
var _ = testkit.Spec("TestAppendMarkdownSection", func(t testkit.T) {
