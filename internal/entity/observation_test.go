...
var _ = ginkgo.Describe("TestObservationRoundTrip", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestObservationMultipleArtifacts", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestObservationLegacyBackfill", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
...
var _ = ginkgo.Describe("TestObservationRoundTrip_PreservesEvidenceFailures", func() {
	ginkgo.It("runs", func() {
		t := testkit.NewT()
