...
var _ = testkit.Spec("TestObservationRoundTrip", func(t testkit.T) {
	pass := true
	low := 0.0045
	high := 0.0051
...
var _ = testkit.Spec("TestObservationMultipleArtifacts", func(t testkit.T) {
	o := &entity.Observation{
		ID:         "O-0005",
		Experiment: "E-0002",
		Instrument: "objdump",
...
var _ = testkit.Spec("TestObservationLegacyBackfill", func(t testkit.T) {
...
var _ = testkit.Spec("TestObservationRoundTrip_PreservesEvidenceFailures", func(t testkit.T) {
	ciLow := 95.0
	ciHigh := 105.0
